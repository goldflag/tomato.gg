...
export const { formatString, ...commonStrings } = LocalizedStrings({
    ...
    hr: {
        ...
        nBattles: "{0} bitaka",
        dpg: "DPG",
        longDPG: "šteta po bitci",
        frags: "fragovi",
        longFrags: "fragovi po bitci",
        winrate: "pobjede",
        tier: "razina",
        wn8: "WN8",
        dmgRatio: "omjer štete",
        longDmgRatio: "omjer oštećenja",
        kd: "K/D",
        longKD: "omjer ubijanja i smrti",
        rank: "rang",
        overall: "ukupno",
        days: "{0} dana",
        hours: "{0} sata",
...
export const clanPositions = LocalizedStrings({
    ...
    hr: {
        ...
        executive_officer: "Izvršni Oficir",
        personnel_officer: "Oficir za Osoblje",
        combat_officer: "Borbeni Oficir",
        intelligence_officer: "Obavještajni Službenik",
