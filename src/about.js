                ...
                <Paper style={{
                    ...
                    <div>
                        ...
                        <span style={{ fontSize: '0.9rem', lineHeight: '1.4rem' }}>
                            I created this site to provide an accessible interface to view a huge variety of stats, many of which are only found here. Some stats have taken inspiration from the other sites.<br />
                            ...
                            You can Tomato.gg on your phone, but this is mainly a desktop app. I will not leave out statistics on the mobile version even if it makes the site looks worse on mobile. <br /><br />
