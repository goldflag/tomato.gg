      ...
      <div style = {{padding: '2em', paddingTop: '5em'}}>
        ...
        <Paper className={useStyles.paper}>
          <div style={{padding: '1rem', color: 'rgb(50,50,50)'}}>
            ...
            <span style={{fontSize: '0.9rem', lineHeight: '1.4rem'}}>I created this site to provide an accessible interface to view a huge variety of stats. Many (but not all) of the stats on tomato.gg are readily available on other sites, 
            but I've never seen an easy-to-use website that covers all of the most important stats<br/>
            ...
            Tomato.gg doesn't aim to do everything. It will never have server stats as detailed as those on wot-news.com, nor will it have the percise individual battle stats that WN8lab.com. If you want to see detailed period based winrate curves, go to wot-news.com<br/><br/>
