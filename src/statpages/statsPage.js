...
export default function StatsPage(props) {
    ...
    async function FetchTankData() {
        ...
        const tankList = await fetch(
            `https://api.worldoftanks.com/wot/encyclopedia/vehicles/?application_id=${APIKey}&fields=short_name%2C+tier%2C+type%2C+nation%2C+is_premium%2C+is_gift`
        );
