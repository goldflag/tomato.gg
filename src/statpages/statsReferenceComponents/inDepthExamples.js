        ...
        <div className={classes.root}>
            ...
            >
                ...
                <TabPanel value={value} index={1} dir={t.direction}>
                    ...
                    consensus that the Progetto is overpowered.
                    <br />
                    <br />
                    However, you have probably noticed that the portion of the tank curve for lower winrates and WN8s is
                    not that different from the overall reference curve. This means the Progetto is not overpowered in
                    the hands of a shitter. This confirms the idea that autoreloaders like the Progetto 46 have a high
                    skill ceiling.
                </TabPanel>
                <TabPanel value={value} index={0} dir={t.direction}>
                    ...
                    AT 8 appears to confirm this. The tank curve is higher at the lower overall winrates, but drops down
                    to the reference curve at higher overall winrate.
                    <br />
                    <br />
                    The WN8 curve for the AT 8 is also quite interesting. It sits entirely below the reference curve,
                    meaning the AT 8 is really bad for WN8 padding (especially if you are a good player).
                    <br />
                    Don't mind the the sudden dropoff at the unicum WN8s — the datapoints are very noisy and sparse at
                    those levels.
                </TabPanel>
            </div>
        </div>
