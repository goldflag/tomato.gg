...
export default function StatsReference(props) {
    ...
    return (
        <>
            <Helmet>
                <title>Stats Reference - Tomato.gg</title>
            </Helmet>
                    ...
                    >
                        ...
                        >
                            ...
                            <span style={{ fontSize: "0.9rem", lineHeight: "1.4rem" }}>
                                ...
                                .<br />
                                Tank curves compare an player's overall account performance to their performance on an
                                individual tank and is probably{" "}
                                <strong>
                                    the most accurate tool in determining the vehicle's position in the metagane
                                </strong>
                                .<br />
                                <br />
                                ...
                                >
                                    Understanding Percentile Graphs | Bourrasque Analysis
                                </h2>
