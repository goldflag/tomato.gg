...
import { classDescConv, nationAdjConv } from "Data/conversions";
...
const TreeMapTooltip = ({ node, type }) => {
    ...
    const nationClassAdj = nationAdjConv.formatString(nationAdjConv[data.nation], classDesc);
    ...
    if (isLeaf && type === "Overall") {
        ...
        headerContent = `${data.name} | ${nationClassAdj}`;
        gridItems = [
