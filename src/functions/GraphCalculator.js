    ...
    const data = {
        ...
        'overallStats' : [
            {'name': 'Battles', 
                ...
                '3 Days': recent1week.battles, 
                '7 Days': recent30days.battles, 
                '30 Days': recent60days.battles,
            ...
            {'name': 'Avg Tier', 
                ...
                '3 Days': recent1week.tier, 
                '7 Days': recent30days.tier,  
                '30 Days': recent60days.tier,  
            ...
            {'name': 'WN8', 
                ...
                '3 Days': recent1week.overallWN8, 
                '7 Days': recent30days.overallWN8, 
                '30 Days': recent60days.overallWN8, 
            ...
            {'name': 'Wins', 
                ...
                '3 Days': <>{recent1week.wins}<span style={{ float: 'right', color: clr(recent1week.winrate, (OS.wins*100/OS.battles))}}>{recent1week.winrate}%</span></>, 
                '7 Days': <>{recent30days.wins}<span style={{ float: 'right', color: clr(recent30days.winrate, (OS.wins*100/OS.battles))}}>{recent30days.winrate}%</span></>, 
                '30 Days': <>{recent60days.wins}<span style={{ float: 'right', color: clr(recent60days.winrate, (OS.wins*100/OS.battles))}}>{recent60days.winrate}%</span></>, 
            ...
            {'name': 'Losses', 
                ...
                '3 Days': <>{recent1week.losses}<span style={{ float: 'right', color: clr(recent1week.lossrate, (OS.losses*100/OS.battles), true)}}>{recent1week.lossrate}%</span></>, 
                '7 Days': <>{recent30days.losses}<span style={{ float: 'right', color: clr(recent30days.lossrate, (OS.losses*100/OS.battles), true)}}>{recent30days.lossrate}%</span></>, 
                '30 Days': <>{recent60days.losses}<span style={{ float: 'right', color: clr(recent60days.lossrate, (OS.losses*100/OS.battles), true)}}>{recent60days.lossrate}%</span></>, 
            ...
            {'name': 'Draws', 
                ...
                '3 Days': <>{recent1week.draws}<span style={{ float: 'right', color: clr(recent1week.drawrate, (OS.draws*100/OS.battles), true)}}>{recent1week.drawrate}%</span></>, 
                '7 Days': <>{recent30days.draws}<span style={{ float: 'right', color: clr(recent30days.drawrate, (OS.draws*100/OS.battles), true)}}>{recent30days.drawrate}%</span></>,  
                '30 Days': <>{recent60days.draws}<span style={{ float: 'right', color: clr(recent60days.drawrate, (OS.draws*100/OS.battles), true)}}>{recent60days.drawrate}%</span></>,  
            ...
            {'name': 'Damage', 
                ...
                '3 Days': <>{recent1week.damage}<span style={{ float: 'right', color: clr(recent1week.damagerate, (OS.damage_dealt/OS.battles))}}>{recent1week.damagerate}</span></>, 
                '7 Days': <>{recent30days.damage}<span style={{ float: 'right', color: clr(recent30days.damagerate, (OS.damage_dealt/OS.battles))}}>{recent30days.damagerate}</span></>, 
                '30 Days': <>{recent60days.damage}<span style={{ float: 'right', color: clr(recent60days.damagerate, (OS.damage_dealt/OS.battles))}}>{recent60days.damagerate}</span></>, 
            ...
            {'name': 'Frags', 
                ...
                '3 Days': <>{recent1week.frags}<span style={{ float: 'right', color: clr(recent1week.fragsrate, (OS.frags/OS.battles))}}>{recent1week.fragsrate}</span></>, 
                '7 Days': <>{recent30days.frags}<span style={{ float: 'right', color: clr(recent30days.fragsrate, (OS.frags/OS.battles))}}>{recent30days.fragsrate}</span></>, 
                '30 Days': <>{recent60days.frags}<span style={{ float: 'right', color: clr(recent60days.fragsrate, (OS.frags/OS.battles))}}>{recent60days.fragsrate}</span></>, 
            ...
            {'name': 'K/D Ratio', 
                ...
                '3 Days': <><span style={{ color: clr(recent1week.KD, (OS.frags/(OS.battles - OS.survived_battles)))}}>{recent1week.KD}</span></>, 
                '7 Days': <><span style={{ color: clr(recent30days.KD, (OS.frags/(OS.battles - OS.survived_battles)))}}>{recent30days.KD}</span></>, 
                '30 Days': <><span style={{ color: clr(recent60days.KD, (OS.frags/(OS.battles - OS.survived_battles)))}}>{recent60days.KD}</span></>, 
            ...
            {'name': 'Damage Ratio', 
                ...
                '3 Days': <><span style={{ color: clr(recent1week.DMGratio, (OS.damage_dealt/(OS.damage_received)))}}>{recent1week.DMGratio}</span></>, 
                '7 Days': <><span style={{ color: clr(recent30days.DMGratio, (OS.damage_dealt/(OS.damage_received)))}}>{recent30days.DMGratio}</span></>, 
                '30 Days': <><span style={{ color: clr(recent60days.DMGratio, (OS.damage_dealt/(OS.damage_received)))}}>{recent60days.DMGratio}</span></>, 
            ...
            {'name': 'Survived', 
                ...
                '3 Days': <>{recent1week.survived}<span style={{ float: 'right', color: clr(recent1week.survivedrate, (OS.survived_battles*100/(OS.battles)))}}>{recent1week.survivedrate}%</span></>, 
                '7 Days': <>{recent30days.survived}<span style={{ float: 'right', color: clr(recent30days.survivedrate, (OS.survived_battles*100/(OS.battles)))}}>{recent30days.survivedrate}%</span></>,
                '30 Days': <>{recent60days.survived}<span style={{ float: 'right', color: clr(recent60days.survivedrate, (OS.survived_battles*100/(OS.battles)))}}>{recent60days.survivedrate}%</span></>,
            ...
            {'name': 'Detected', 
                ...
                '3 Days': <>{recent1week.spotted}<span style={{ float: 'right', color: clr(recent1week.spottedrate, (OS.spotted/(OS.battles)))}}>{recent1week.spottedrate}</span></>, 
                '7 Days': <>{recent30days.spotted}<span style={{ float: 'right', color: clr(recent30days.spottedrate, (OS.spotted/(OS.battles)))}}>{recent30days.spottedrate}</span></>,  
                '30 Days': <>{recent60days.spotted}<span style={{ float: 'right', color: clr(recent60days.spottedrate, (OS.spotted/(OS.battles)))}}>{recent60days.spottedrate}</span></>,
            ...
            {'name': 'Cap Points', 
                ...
                '3 Days': <>{recent1week.cap}<span style={{ float: 'right', color: clr(recent1week.caprate, (OS.capture_points/(OS.battles)))}}>{recent1week.caprate}</span></>, 
                '7 Days': <>{recent30days.cap}<span style={{ float: 'right', color: clr(recent30days.caprate, (OS.capture_points/(OS.battles)) )}}>{recent30days.caprate}</span></>, 
                '30 Days': <>{recent60days.cap}<span style={{ float: 'right', color: clr(recent60days.caprate, (OS.capture_points/(OS.battles)))}}>{recent60days.caprate}</span></>, 
            ...
            {'name': 'Def Points', 
                ...
                '3 Days': <>{recent1week.def}<span style={{ float: 'right', color: clr(recent1week.defrate, (OS.dropped_capture_points/(OS.battles)))}}>{recent1week.defrate}</span></>, 
                '7 Days': <>{recent30days.def}<span style={{ float: 'right', color: clr(recent30days.defrate, (OS.dropped_capture_points/(OS.battles)))}}>{recent30days.defrate}</span></>, 
                '30 Days': <>{recent60days.def}<span style={{ float: 'right', color: clr(recent60days.defrate, (OS.dropped_capture_points/(OS.battles)))}}>{recent60days.defrate}</span></>,
            ...
            {'name': 'Experience', 
                ...
                '3 Days': <>{recent1week.xp}<span style={{ float: 'right', color: clr(recent1week.xprate, (OS.battle_avg_xp))}}>{recent1week.xprate}</span></>,
                '7 Days': <>{recent30days.xp}<span style={{ float: 'right', color: clr(recent30days.xprate, (OS.battle_avg_xp))}}>{recent30days.xprate}</span></>, 
                '30 Days': <>{recent60days.xp}<span style={{ float: 'right', color: clr(recent60days.xprate, (OS.battle_avg_xp))}}>{recent60days.xprate}</span></>, 
