...
export default function calcTrackingVals(BattleCount, BattleTracker, EXPTracker, WinsCount, raw) {
    ...
    WinsCount[classToIndex[Conversion[tankNames[id]['type']]]][tierToKey[tankNames[id]['tier']]] += (raw.winrate*battles/100);
    WinsCount[5][tierToKey[tankNames[id]['tier']]] += raw.winrate*battles/100;

    BattleTracker[classToIndex[Conversion[tankNames[id]['type']]]][tierToKey[tankNames[id]['tier']]].dmg += raw.damage;
    BattleTracker[classToIndex[Conversion[tankNames[id]['type']]]][tierToKey[tankNames[id]['tier']]].spot += raw.spots;
    BattleTracker[classToIndex[Conversion[tankNames[id]['type']]]][tierToKey[tankNames[id]['tier']]].frag += raw.frags;
    BattleTracker[classToIndex[Conversion[tankNames[id]['type']]]][tierToKey[tankNames[id]['tier']]].def += raw.def;
    BattleTracker[classToIndex[Conversion[tankNames[id]['type']]]][tierToKey[tankNames[id]['tier']]].wr += raw.winrate*battles;
    ...
    EXPTracker[classToIndex[Conversion[tankNames[id]['type']]]][tierToKey[tankNames[id]['tier']]].dmg += exp.expDamage*battles;
    EXPTracker[classToIndex[Conversion[tankNames[id]['type']]]][tierToKey[tankNames[id]['tier']]].spot += exp.expSpot*battles;
    EXPTracker[classToIndex[Conversion[tankNames[id]['type']]]][tierToKey[tankNames[id]['tier']]].frag += exp.expFrag*battles;
    EXPTracker[classToIndex[Conversion[tankNames[id]['type']]]][tierToKey[tankNames[id]['tier']]].def += exp.expDef*battles;
    EXPTracker[classToIndex[Conversion[tankNames[id]['type']]]][tierToKey[tankNames[id]['tier']]].wr += exp.expWinRate*battles;
