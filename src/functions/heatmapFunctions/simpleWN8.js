...
export default function simpleWN8(c, t, BattleTracker, EXPTracker) {
    const rDAMAGE =
        BattleTracker[c][tierToKey[t]].dmg / EXPTracker[c][tierToKey[t]].dmg;
    const rSPOT =
        BattleTracker[c][tierToKey[t]].spot / EXPTracker[c][tierToKey[t]].spot;
    const rFRAG =
        BattleTracker[c][tierToKey[t]].frag / EXPTracker[c][tierToKey[t]].frag;
    const rDEF =
        BattleTracker[c][tierToKey[t]].def / EXPTracker[c][tierToKey[t]].def;
    const rWIN =
        BattleTracker[c][tierToKey[t]].wr / EXPTracker[c][tierToKey[t]].wr;
